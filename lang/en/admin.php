...
$string['participantsdefaultsort'] = 'Participants table default sort';
$string['participantsdefaultsort_desc'] = 'The field that the participants or enrolled users table will be sorted by, by default';
