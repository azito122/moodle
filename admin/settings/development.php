...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configselect('participantsdefaultsort', new lang_string('participantsdefaultsort', 'admin'),
        new lang_string('participantsdefaultsort_desc', 'admin'), 'lastname', array(
